...
class SavingAccount extends BankAccount {
  ...
  generateIncome(currentDay) {
		if(currentDay === this.IncomeDay) {
			...
			this.balance += income;
			console.log(`Seu saldo foi atualizado com o rendimento. Seu saldo atual é de R$ ${this.balance.toFixed(2)}`);
		} else {
			console.log(`Ainda não é dia de rendimento. O dia para retirada de rendimento é ${this.IncomeDay}`);
		}
	}
}
