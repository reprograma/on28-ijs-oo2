...
export class SavingAccount extends BankAccount {
  ...
  generateIncome(currentDay) {
    if (currentDay === this.incomeDay) {
      ...
      console.log(`Rendimento atualizado! Seu saldo atual é R$ ${this.balance}, 00`)
    } else {
      throw (`Não foi possível gerar rendimento no dia de hoje. Seu saldo atual é R$ ${this.balance}, 00`)
    }
  }
}